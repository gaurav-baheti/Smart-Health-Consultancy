...
<html>
  ...
  <body>
    ...
    <div>
      <div class="card-header" style="margin: 10px; padding: 15px; font-size: 30px; font-weight: bolder; color: black; font-family: 'Times New Roman', Times, serif;">Disease Predection</div>
      <div class="content">
        <form method="POST" action="" >
            <input type="text" name="disease" placeholder="Search For Disease">
