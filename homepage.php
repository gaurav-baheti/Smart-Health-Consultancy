...
<html>
  ...
  <body>
    <nav class="navbar navbar-expand-md bg-dark navbar-dark">
      ...
      <button class="navbar-toggler"  class="navbar-toggle collapsed" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="index.html" style="font-size: 20px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill-rule="evenodd" d="M3 3.25c0-.966.784-1.75 1.75-1.75h5.5a.75.75 0 010 1.5h-5.5a.25.25 0 00-.25.25v17.5c0 .138.112.25.25.25h5.5a.75.75 0 010 1.5h-5.5A1.75 1.75 0 013 20.75V3.25zm16.006 9.5l-3.3 3.484a.75.75 0 001.088 1.032l4.5-4.75a.75.75 0 000-1.032l-4.5-4.75a.75.75 0 00-1.088 1.032l3.3 3.484H10.75a.75.75 0 000 1.5h8.256z"></path></svg> Log Out</a>
          </li>
        </ul>
      </div>
    </nav>
    <div class="card" style="background: inherit;">
      <div class="card-header" style=" margin: 10px; padding: 15px; font-size: 30px; font-weight: bolder; color: black;  font-family: 'Times New Roman', Times, serif;">Details</div>
      <div class="content" >
        <?php
          echo'<h2 style = " text-transform: capitalize;">First Name : '.$_SESSION['fname'];
          echo'<br><br>Last Name : '.$_SESSION['lname'];
          echo'</h2><br><h2 style ="font-family: "Times New Roman", Times, serif;">Email : '.$_SESSION['email'];
          echo'<br><br>Username : '.$_SESSION['user'];
          echo'<br><br>Date of Birth : '.$_SESSION['dob'];
          echo'<br><br>Gender : '.$_SESSION['gender'];
          echo'<br><br>Mobile : '.$_SESSION['mobile'];
        ?>
      </div>
    </div>
  </body>
